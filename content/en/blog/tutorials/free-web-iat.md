...
If you go to [our example](https://github.com/baranan/minno-tasks/blob/master/docs/studies/datapipe.example.iat/raceiat.js), you will see one example for how to define your own IAT:
