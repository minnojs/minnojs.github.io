...
4. In the manager file (e.g., [this](https://github.com/baranan/minno-tasks/blob/master/docs/studies/datapipe.example.iat1/mgr.js), if you copied my example), replace the datapipe token (zpjKaPesdEOI) with your datapipe token. 
