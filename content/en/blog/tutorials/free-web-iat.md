...
If you go to [our example study](https://github.com/baranan/minno-tasks/blob/master/docs/studies/datapipe.example.iat/raceiat.js), you will see how to define an IAT:
